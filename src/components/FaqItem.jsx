  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      >
        ...
        <div
          className={clsx(
            "faq-icon relative flex size-12 justify-center items-center rounded-full border-s2 border-2 shadow-400 transition-all duration-500 group-hover:border-s4",
